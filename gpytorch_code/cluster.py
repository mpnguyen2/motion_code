...
def cluster_dtw(time_series, threshold_dist, plot_file='output_plots/plot_cluster.png'):
...
def cluster_vector(latent_vectors, num_cluster, plot_file='output_plots/plot_cluster_vec.png'):
